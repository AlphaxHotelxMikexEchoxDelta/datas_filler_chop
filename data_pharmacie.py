...
for donnees_pharmacie in donnees_pharmacies:
    if 'fields' in donnees_pharmacie and all(key in donnees_pharmacie['fields'] for key in ['rs', 'numvoie', 'typvoie', 'voie', 'cp', 'commune', 'wgs84']):
        ...
        nouvelle_donnee_pharmacie = {
            ...
            "lat": donnees_pharmacie['fields']['wgs84'][0],
            "lon": donnees_pharmacie['fields']['wgs84'][1]
        }
